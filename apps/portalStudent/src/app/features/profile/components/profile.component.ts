...
@Component({
            ...
            <div class="profile-fields">
              <div class="field-row">
                ...
                <div class="field">
                  ...
                  <span class="field-value">{{ admissionNo() }}</span>
                </div>
              </div>
              <div class="field-row">
                <div class="field">
                ...
                <div class="field">
                  <span class="field-label">Grade / Form</span>
                  <span class="field-value">{{ grade() }}</span>
                </div>
              </div>
            </div>
          </mat-card-content>
  ...
  styles: [`
    ...
    .profile-container { max-width: 720px; margin: 0 auto; padding: 24px; }
    ...
    .profile-card { background: var(--mnara-surface); }
...
export class ProfileComponent {
  ...
  readonly admissionNo = computed(() => this.authStore.user()?.user?.schoolId ?? this.authStore.identifier());
